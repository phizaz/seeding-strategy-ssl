...
this is more general than KmeansMocking
An attemp to tighten the lower bound
use the given clusters with sub-groups (using l-method + kmeans)
...
class ClusterMockingNestedSplit:

    def __init__(self, X, labels, method='ward'):
