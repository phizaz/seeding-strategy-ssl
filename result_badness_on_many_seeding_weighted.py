...
- agglomerative l-method hierarchical clustering + weighted
- kde + denclue (hill climbing) + weighted
- naive
'''
...
def run_and_save(dataset):
    ...
    with open('results/badness_on_many_seeding_weighted-' + dataset.name + '.json', 'w') as file:
